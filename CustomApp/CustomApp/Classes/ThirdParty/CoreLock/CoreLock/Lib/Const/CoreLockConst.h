 ...
 *  外环线条颜色：默认
 */
#define CoreLockCircleLineNormalColor rgba(142,142,142,1)//rgba(241,241,241,1)


/*
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(51, 167, 196, 1)//rgba(34,178,246,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(51, 167, 196, 1)


/*
 *  实心圆
 */
#define CoreLockLockLineColor rgba(51, 167, 196, 1)
